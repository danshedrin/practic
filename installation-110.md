# Инсталляция среды разработки JetBrains PyCharm Community Edition
### ИСР 1.10
...
Заходим на сайт <a href="https://www.jetbrains.com/pycharm/">по ссылке</a> и нажимаем на кнопку **Download**.
...
<p>Выбираем некоммерческую версию Community Edition и подбираем нужную ветку программы, исходя из системы и архитектуры процессора.</p>
...
<p>Скачивание образа начнется автоматически. Если возникли проблемы, нажмите на прямую ссылку самостоятельно.</p>
...
Дождитесь скачивания и откройте образ через активную кнопку в браузере.
...
Перетащите файл приложение ПКМ в папку Программы и после переноса откройте PyCharm. Среда разработки обычно определяет системный интерпретатор автоматически. Создайте первый проект и проверьте правильность автоматической настройки среды разработки.
